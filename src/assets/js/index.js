...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "Welcome to the scp Foundation", "author": "..." },
            { "message": "Salut je suis Un launcher du SCPinet", "author": "Scp Foundation" },
            { "message": "Welcome to The Nexuscraft Studio", "author": "johnfr52" }
        ];
